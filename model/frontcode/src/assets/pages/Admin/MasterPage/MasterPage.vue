<template>
  <div id="master-page" style="display: flex; flex-direction: column; min-height: 100vh;">
    <!-- 顶部菜单栏 -->
    <el-header id="head">
    ...
    <el-container style="margin-top: 60px; flex-grow: 1;">
      ...
      <el-main id="mainPart">
        <component
            ...
            @toggleBanRoom="handleToggleBanRoom"
        />
      </el-main>
    </el-container>
  </div>
...
<script src="@/assets/styles/Admin/MasterPage/Master.js"></script>
<style src="@/assets/styles/Admin/MasterPage/Master.css"></style>